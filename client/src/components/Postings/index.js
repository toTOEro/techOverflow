            ...
            <Stack spacing="4" alignItems="center">
...

                {
                    loading ? (
                        ...
                        postings.slice(0, 4).map(({ _id, title, description, email, owners_id }) => (
                            <Card key={_id} maxW='65vw' minW='50vw' size='lg' border='thick' borderColor='black' borderStyle='solid' >
                                ...
                                <Divider />
                                <CardFooter py='1'>
                                    <MailTo email={owners_id.email} label={`Email ${owners_id.email}`} />
                                    <Avatar name={owners_id.firstName} src={'./icons8-user-32.png'} />
                                </CardFooter>
                            </Card>
                        ))
                    )
